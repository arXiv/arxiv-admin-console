...
@pytest.mark.usefixtures("reset_test_database", "database_session", "test_env", "admin_api_db_only_client", "api_headers")
class TestCreateOwnershipRequest:

    def test_create_ownership_request(self, reset_test_database, database_session: Session, test_env, admin_api_db_only_client, api_headers):
        ...
        row: OwnershipRequest = database_session.query(OwnershipRequest).filter(
