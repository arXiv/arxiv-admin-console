...
class ServiceStatusApi:
    ...
    def ctxvar_test_ctxvar_get(
        ...
        _param = self._ctxvar_test_ctxvar_get_serialize(
    ...
    @validate_call
    def ctxvar_test_ctxvar_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ctxvar_test_ctxvar_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _ctxvar_test_ctxvar_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def log_debug_log_get(
        ...
        _param = self._log_debug_log_get_serialize(
            lines=lines,
    ...
    @validate_call
    def log_debug_log_get_with_http_info(
        self,
        lines: Optional[StrictInt] = None,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
    ...
    @validate_call
    def log_debug_log_get_without_preload_content(
        self,
        lines: Optional[StrictInt] = None,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
    ...
    def _log_debug_log_get_serialize(
        self,
        lines,
        authorization,
        modkey,
    ...
    def log_email_log_get(
        ...
        _param = self._log_email_log_get_serialize(
            lines=lines,
            authorization=authorization,
            modkey=modkey,
            arxivng_session_id=arxivng_session_id,
    ...
    @validate_call
    def log_email_log_get_with_http_info(
        self,
        lines: StrictInt,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
    ...
    @validate_call
    def log_email_log_get_without_preload_content(
        self,
        lines: StrictInt,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
    ...
    def _log_email_log_get_serialize(
        self,
        lines,
        authorization,
        modkey,
    ...
    def status_get(
        ...
        Get the status of the ModAPI service as HTTP status code.  Tests connection to DB.
