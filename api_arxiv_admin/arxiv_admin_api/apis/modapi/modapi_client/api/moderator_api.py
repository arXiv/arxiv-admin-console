...
class ModeratorApi:
    ...
    def moderators_get(
        ...
        _param = self._moderators_get_serialize(
    ...
    @validate_call
    def moderators_get_with_http_info(
        self,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
        arxivng_session_id: Optional[StrictStr] = None,
    ...
    @validate_call
    def moderators_get_without_preload_content(
        self,
        authorization: Optional[StrictStr] = None,
        modkey: Optional[StrictStr] = None,
        arxivng_session_id: Optional[StrictStr] = None,
