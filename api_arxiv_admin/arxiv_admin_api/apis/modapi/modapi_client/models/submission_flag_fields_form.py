...
class SubmissionFlagFieldsForm(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["flag_done", "flag_viewed", "flag_pdf_opened"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmissionFlagFieldsForm from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmissionFlagFieldsForm from a dict"""
        if obj is None:
            return None
