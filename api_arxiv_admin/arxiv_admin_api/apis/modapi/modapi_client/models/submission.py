...
class Submission(BaseModel):
    ...
    hold_reason: Optional[StrictStr] = None
    urls: Optional[SubmissionUrls] = None
    __properties: ClassVar[List[str]] = ["submission_id", "doc_paper_id", "created", "updated", "submit_time", "release_time", "status", "status_name", "version", "type", "title", "authors", "abstract", "comments", "is_author", "sword_id", "proxy", "contact_name", "contact_email", "report_num", "msc_class", "acm_class", "journal_ref", "doi", "is_ok", "admin_ok", "auto_hold", "is_locked", "categories", "submitter", "comment_count", "matched", "hold_type", "hold_reason", "urls"]

    @field_validator('hold_reason')
    def hold_reason_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['discussion', 'moretime', 'scope', 'softreject', 'hardreject', 'nonresearch', 'salami', 'qachecks', 'reject-other', 'other']):
            raise ValueError("must be one of enum values ('discussion', 'moretime', 'scope', 'softreject', 'hardreject', 'nonresearch', 'salami', 'qachecks', 'reject-other', 'other')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hold_reason": obj.get("hold_reason"),
