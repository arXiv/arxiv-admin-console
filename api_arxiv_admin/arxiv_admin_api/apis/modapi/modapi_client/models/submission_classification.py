...
class SubmissionClassification(BaseModel):
    ...
    """ # noqa: E501
    secondary: List[StrictStr]
    primary: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["secondary", "primary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmissionClassification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmissionClassification from a dict"""
        if obj is None:
            return None
