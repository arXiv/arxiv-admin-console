...
class CommentUser(BaseModel):
    ...
    username: StrictStr
    __properties: ClassVar[List[str]] = ["is_admin", "is_moderator", "name", "email", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommentUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommentUser from a dict"""
        if obj is None:
            return None
