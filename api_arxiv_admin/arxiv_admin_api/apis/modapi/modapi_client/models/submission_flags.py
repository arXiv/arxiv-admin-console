...
class SubmissionFlags(BaseModel):
    ...
    SubmissionFlags
    """ # noqa: E501
    admins: Optional[List[SubmissionFlagUser]] = None
    students: Optional[List[SubmissionFlagUser]] = None
    primary_moderators: Optional[List[SubmissionFlagUser]] = None
    other: Optional[List[SubmissionFlagUser]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmissionFlags from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmissionFlags from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "admins": [SubmissionFlagUser.from_dict(_item) for _item in obj["admins"]] if obj.get("admins") is not None else None,
            "students": [SubmissionFlagUser.from_dict(_item) for _item in obj["students"]] if obj.get("students") is not None else None,
            "primary_moderators": [SubmissionFlagUser.from_dict(_item) for _item in obj["primary_moderators"]] if obj.get("primary_moderators") is not None else None,
            "other": [SubmissionFlagUser.from_dict(_item) for _item in obj["other"]] if obj.get("other") is not None else None
        })
        return _obj
