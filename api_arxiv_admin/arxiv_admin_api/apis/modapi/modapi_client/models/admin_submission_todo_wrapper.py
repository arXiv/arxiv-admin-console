...
class AdminSubmissionTodoWrapper(BaseModel):
    """
    A submission with a list of priority scores with explanations, and a reason for being included in the queue. 
    """ # noqa: E501
    ...
    submission: Optional[AdminSubmission] = None
    submission_flags: Optional[AdminSubmissionFlags] = None
    __properties: ClassVar[List[str]] = ["reasons", "score", "scores", "submission_id", "submission", "submission_flags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminSubmissionTodoWrapper from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminSubmissionTodoWrapper from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "submission": AdminSubmission.from_dict(obj["submission"]) if obj.get("submission") is not None else None,
